...
namespace Fycn.PaymentLib.ali
{
    ...
    public class Config
    {
        ...
        */
        ...
        public static string notify_url = PathConfig.NotidyAddr+"/Machine/PostPayResultA";//Path.PathConfig + "/m.html#/payresult";

        // 页面跳转同步通知页面路径，需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
        public static string return_url = PathConfig.DomainConfig + "/m.html#/payresult";
        ...
        public static string refund_notify_url = PathConfig.NotidyAddr + "/Refund/PostRefundResultA"; //退款通知
