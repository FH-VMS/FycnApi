...
namespace Fycn.Sockets.AsyncSocketProtocol
{
    public class HandelSocketProtocol : BaseSocketProtocol
    {
        public HandelSocketProtocol(AsyncSocketServer asyncSocketServer, AsyncSocketUserToken asyncSocketUserToken)
            : base(asyncSocketServer, asyncSocketUserToken)
        {
            m_socketFlag = "HandelSocket";
        }
