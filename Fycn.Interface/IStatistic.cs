...
namespace Fycn.Interface
{
    public interface IStatistic
    {
        ...
        MicroDataTable GetSalesAmountByMachine(string salesDateStart, string salesDateEnd, bool needPage, int pageIndex, int pageSize);
        ...
        MicroDataTable GetStatisticSalesMoneyByDate(SaleModel saleInfo);
    }
}
